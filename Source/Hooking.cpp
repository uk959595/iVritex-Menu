...
int IconNotification(char* text, char* text2, char* Subject)
{
	...
	UI::_SET_NOTIFICATION_MESSAGE_CLAN_TAG("CHAR_SOCIAL_CLUB", "CHAR_SOCIAL_CLUB", false, 7, text2, Subject, 1.0, "___ICES");
...
void Hooking::FindPatterns()
{
	...
	//HANDLE steam = GetModuleHandleA("d3dcsx_46.dll");
