...
namespace PLAYER
{
	...
	static void SET_POLICE_RADAR_BLIPS(Any toggle) { invoke<Void>(0x43286D561B72B8BF, toggle); } // 0x43286D561B72B8BF 0x8E114B10
...
namespace UI
{
	...
	static void ADD_TEXT_COMPONENT_SUBSTRING_PLAYER_NAME_PMENU(const char* text, char* info) { invoke<Void>(0x6C188BE134E074AA, text); } //for pmenu
...
namespace STATS
{
	...
	static BOOL STAT_SET_INT(Hash statName, int value, BOOL save) { return invoke<BOOL>(0xB3271D7AB655B441, statName, value, true); } // 0xB3271D7AB655B441 0xC9CC1C5C
